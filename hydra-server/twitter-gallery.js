...
module.exports = application => {
  ...
  application.get('/sketches', function(request, response) {
  ...
  application.get('/sketchById', function(request, response) {
  ...
  application.post('/sketch', function(request, response) {
  ...
  // application.post('/image', function (request, response) {
  //   console.log('post sketch', request.query)
  // })
  ...
  if (process.env.CONSUMER_KEY) {
    ...
    application.post('/image', upload.single('previewImage'), (req, res) => {
          ...
          function(err, data) {
            if (err) {
              ...
              res
                .status(200)
                .send(
                  'https://twitter.com/hydra_patterns/status/' + data.id_str,
                );
              db.update(
